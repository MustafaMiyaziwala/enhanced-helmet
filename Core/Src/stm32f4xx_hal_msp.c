...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(ULTRA_RIGHT_ADC_IN10_GPIO_Port, ULTRA_RIGHT_ADC_IN10_Pin);

    HAL_GPIO_DeInit(GPIOB, ULTRA_LEFT_ADC_IN8_Pin|ULTRA_CENTER_ADC1_IN9_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI3_MspDeInit 0 */
    ...
    PC12     ------> SPI3_MOSI
    */
    HAL_GPIO_DeInit(GPIOC, DAC_SPI3_SCK_Pin|DAC_SPI3_MOSI_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PA12     ------> USART1_RTS
    */
    HAL_GPIO_DeInit(GPIOA, XBEE_USART_TX_Pin|XBEE_USART_RX_Pin|XBEE_USART_CTS_Pin|XBEE_USART_RTS_Pin);
